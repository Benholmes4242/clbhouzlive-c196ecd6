...
FOR INSERT USING (bucket_id = 'avatars' AND false);
...
FOR INSERT USING (bucket_id = 'course-review-media' AND false);

-- Block all new uploads to logos bucket
CREATE POLICY "Block all logos uploads" ON storage.objects
FOR INSERT USING (bucket_id = 'logos' AND false);
