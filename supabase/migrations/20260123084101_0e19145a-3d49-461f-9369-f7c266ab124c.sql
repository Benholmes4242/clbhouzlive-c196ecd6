-- Drop all three handicap leaderboard functions
...
-- 1. Recreate get_handicap_improvement_leaderboard with correct column
...
-- 2. Recreate get_lowest_handicap_leaderboard with correct column
...
-- 3. Recreate get_season_improvement_leaderboard with correct column
...
GRANT EXECUTE ON FUNCTION public.get_lowest_handicap_leaderboard(text, integer, integer, uuid) TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_season_improvement_leaderboard(text, integer, integer, uuid) TO anon, authenticated;