-- Fix notify_business_team_added to use allowed notification type 'business_member_added'
...
BEGIN
  ...
  -- Insert notification with correct type (business_member_added is in the constraint)
