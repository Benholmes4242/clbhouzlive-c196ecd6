-- Add p_country parameter to get_exploration_leaderboard RPC
-- This enables filtering the Travellers leaderboard by country

CREATE OR REPLACE FUNCTION get_exploration_leaderboard(
  ...
  p_country text DEFAULT NULL  -- NEW: Filter by country
)
RETURNS TABLE(
  rank bigint,
  user_id uuid,
