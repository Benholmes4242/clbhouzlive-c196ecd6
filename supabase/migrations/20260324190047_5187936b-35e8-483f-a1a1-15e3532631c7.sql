...
BEGIN
  ...
  SELECT
    ...
    wm.wm_media_duration_ms,
    wm.wm_source_review_id, wm.wm_review_rating, wm.wm_review_course_name,
    wm.wm_review_course_id, wm.wm_review_course_image, wm.wm_review_course_region,
    wm.wm_review_course_country, wm.wm_review_course_sub_country, wm.wm_review_text,
    wm.wm_course_id, wm.wm_course_name, wm.wm_course_club_name,
    wm.wm_score, wm.wm_post_tags
  FROM with_media wm
  ORDER BY
    CASE WHEN v_mode = 'popular' THEN wm.wm_score ELSE NULL END DESC NULLS LAST,
