-- Fix ambiguous course_id references in get_top100_course_leaderboard
...
BEGIN
  ...
  course_stats AS (
    SELECT 
      ...
      -- User-specific data with explicit table aliases
  ...
  with_ranks AS (
    SELECT 
      ...
      -- Get previous rank from history with explicit alias
