-- Fix the course leaderboard RPC - remove non-existent club_name column reference
-- The golf_courses table has club_id (FK) not club_name
...
BEGIN
  ...
  WITH course_stats AS (
    SELECT
      ...
      COALESCE(gclub.name, gc.name) as club_name,  -- Get club name from golf_clubs table
      gc.country,
