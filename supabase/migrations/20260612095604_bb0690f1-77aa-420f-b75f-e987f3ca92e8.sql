...
AS $function$
  WITH base AS (
    SELECT
      ...
      NULL::text AS friend_profile_photo_url,
      up.eg_handicap_index AS friend_handicap_index,
      up.home_club AS friend_home_club,
      (
    ...
    SELECT
      ...
      up2.profile_photo_url AS friend_profile_photo_url,
    ...
    LEFT JOIN public.user_profiles up2 ON up2.id = fm.friend_user_id
    WHERE fm.owner_user_id = p_user_id
  )
  SELECT
    base.is_self,
    base.friend_user_id,
    base.friend_connection_id,
    base.friend_passport_id,
    base.friend_row_id,
    base.friend_name,
    base.friend_thumbnail_url,
    base.friend_profile_photo_url,
    base.friend_handicap_index,
    base.friend_home_club,
    base.last_round_played_at,
    base.last_round_course_name,
    base.is_clbhouz_user,
    (
