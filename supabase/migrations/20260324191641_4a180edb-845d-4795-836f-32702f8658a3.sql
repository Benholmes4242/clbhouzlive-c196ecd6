  ...
  with_media AS (
    SELECT
      ...
      CASE
        ...
        ELSE COALESCE(s.post_type, 'post')
      END AS wm_post_type,
      s.created_at AS wm_post_created_at,
      s.content AS wm_post_caption,
      NULL::text AS wm_post_location,
      s.like_count AS wm_post_like_count,
      s.comment_count AS wm_post_comment_count,
      0 AS wm_post_share_count,
      s.is_pinned AS wm_post_is_pinned,
      NULL::text[] AS wm_post_hashtags,
      ...
      s.actor_id::text AS wm_actor_id,
