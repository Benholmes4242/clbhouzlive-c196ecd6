-- get_activity_feed: add 'badge_earned' to the game family so badges land in
-- the Crowns tab and stay excluded from All / New / Mentions / Friends.
--
-- KEEP IN LOCKSTEP WITH GAME_NOTIF_TYPES in
-- src/features/activity-v2/components/ledgerKinds.tsx and activityCopy() in
