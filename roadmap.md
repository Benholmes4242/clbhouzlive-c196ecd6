...
- [ ] Canonicalize shared verdict labels and tint Exceptional ghost numerals without changing alpha.
- [ ] Keep the true light-ground rating neutral at #64748B; correct stale dark-ground caller metadata.
- [ ] Preserve reviewTierColor and report its three dependent displays.
- [ ] Measure overlap contrast on dark/light grounds and verify 9.0/8.3 shared surfaces.
- [ ] Report unrelated FeedCard DEAL green and dormant postHelpers without changing them.
