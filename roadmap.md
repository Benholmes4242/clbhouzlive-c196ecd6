...
- [ ] Remove the Gallery hero and place Clips 18px below the fixed header.
- [ ] Open review tiles into a review-first, course-bounded fullscreen media set.
- [ ] Add poster-first Gallery autoplay with a two-video page-wide limit and accessibility/data gates.
