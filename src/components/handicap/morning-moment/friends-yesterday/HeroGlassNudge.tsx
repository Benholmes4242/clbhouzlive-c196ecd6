...
export const HeroGlassNudge: React.FC<{ friend: FriendYesterday }> = ({ friend }) => (
  <GlassShell>
    <CourseHeader courseName={friend.course_name} meta="ROUND POSTED ON CLBHOUZ" />
