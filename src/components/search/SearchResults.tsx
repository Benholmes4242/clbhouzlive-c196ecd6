...
const SearchResults: React.FC<SearchResultsProps> = ({
  ...
  if (loading) {
    return (
      <div className="absolute top-full left-0 right-0 bg-white/50 backdrop-blur-xl border border-gray-200 rounded-xl mt-2 shadow-xl z-[9999] pointer-events-auto animate-fade-in">
  ...
  if (!query.trim()) {
    return (
      <div className="absolute top-full left-0 right-0 bg-white/50 backdrop-blur-xl border border-gray-200 rounded-xl mt-2 shadow-xl z-[9999] max-h-[80vh] overflow-y-auto pointer-events-auto animate-fade-in">
        <div className="p-4">
          {/* Trending Tags */}
