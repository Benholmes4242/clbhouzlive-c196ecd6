...
const SearchResults: React.FC<SearchResultsProps> = ({
  ...
  if (loading) {
    return (
      <div className="absolute top-full left-0 right-0 bg-background border border-border rounded-md mt-1 shadow-lg z-[100]">
  ...
  return (
    <div className="absolute top-full left-0 right-0 bg-background border border-border rounded-md mt-1 shadow-lg z-[100] max-h-96 overflow-y-auto">
      {results.map((result) => (
        <div
