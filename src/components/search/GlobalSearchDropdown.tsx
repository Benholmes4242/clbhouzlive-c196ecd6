...
const GlobalSearchDropdown: React.FC<GlobalSearchDropdownProps> = ({
  ...
  const dropdownContent = (
    <div
      ref={dropdownRef}
      className={cn(
        "absolute left-1/2 -translate-x-1/2 top-full mt-2 z-[1500] search-dropdown",
  ...
  if (isMobile) {
    return (
      <div className="fixed inset-x-0 top-16 bottom-0 z-[1500] pointer-events-auto search-dropdown">
