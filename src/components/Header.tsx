  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="container mx-auto px-4 max-w-full box-border bg-transparent">
        <div className="flex items-end justify-between h-16 max-w-full">
          {/* Logo - Enlarged and optimized positioning */}
          <div className="flex items-end flex-shrink-0 gap-1 md:gap-2 py-1 min-w-0">
            <img
          ...
          {/* Search Bar - Desktop */}
          <div className="flex-1 max-w-md mx-2 md:mx-4 min-w-0 flex items-end transform translate-y-2">
            <HeaderSearch />
          </div>

          {/* Navigation Icons */}
          <div className="flex items-end space-x-1 md:space-x-4 flex-shrink-0 min-w-0 transform translate-y-2">
            <HeaderNavigation />
          </div>
        </div>
      </div>
