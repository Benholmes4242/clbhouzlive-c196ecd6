    ...
    <header className="sticky top-0 z-50">
      <div className="container mx-auto px-4 max-w-full box-border bg-transparent">
        <div className="flex items-end justify-between h-16 max-w-full">
          ...
          {/* Search Bar - Desktop */}
          <div className="flex-1 max-w-md mx-2 md:mx-4 min-w-0 flex items-end relative top-2">
            <HeaderSearch />
          </div>

          {/* Navigation Icons */}
          <div className="flex items-end space-x-1 md:space-x-4 flex-shrink-0 min-w-0 relative top-2">
            <HeaderNavigation />
          </div>
        </div>
      </div>
