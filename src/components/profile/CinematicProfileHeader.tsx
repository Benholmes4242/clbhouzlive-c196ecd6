  ...
  return (
     <div className={`relative w-full overflow-hidden ${className}`} 
      ...
      {window.innerWidth < 768 ? (
        // Mobile: Custom shape - square top, rounded bottom, true edge-to-edge, no blur, passes under header
        <div 
          className="group relative overflow-hidden cursor-pointer transition-all duration-500 ease-out hover:scale-105 fixed"
          style={{
            top: '8rem',
            left: '0',
            right: '0',
            ...
            zIndex: 1 // Lower z-index so it passes under header
          }}
