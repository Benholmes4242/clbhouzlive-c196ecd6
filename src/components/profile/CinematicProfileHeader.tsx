  ...
  return (
     <div className={`relative w-full overflow-hidden ${className}`} 
      ...
      {window.innerWidth < 768 ? (
        // Mobile: Custom shape - full width top, squircle bottom corners
        <div 
          ...
          style={{
            ...
            clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 40px), calc(100% - 40px) calc(100% - 20px), calc(100% - 20px) calc(100% - 40px), calc(100% - 20px) 100%, 20px 100%, 20px calc(100% - 40px), 40px calc(100% - 20px), 0 calc(100% - 40px))'
          }}
