  ...
  return (
    <div className={`relative w-full h-80 overflow-hidden ${className}`}>
        ...
        {hasMedia ? (
          <>
            ...
            {profilePhotoUrl && (
              <img
                ref={photoRef}
                src={`${profilePhotoUrl}?quality=100&format=auto&width=2048&height=1536&fit=cover`}
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Top fade */}
        <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-background via-background/80 to-transparent" />
        
        {/* Side fades with blur effect */}
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-background via-background/60 to-transparent backdrop-blur-sm" />
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-background via-background/60 to-transparent backdrop-blur-sm" />
        
        {/* Bottom fade starting from where name appears */}
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-background via-background/90 to-transparent" />
        
        {/* Center cinema vignette */}
        <div className="absolute inset-0 bg-radial-gradient from-transparent via-transparent to-background/30" 
             style={{
               background: 'radial-gradient(ellipse 60% 40% at center, transparent 30%, hsla(var(--background) / 0.1) 60%, hsla(var(--background) / 0.4) 80%, hsla(var(--background) / 0.8) 100%)'
             }} />
      </div>
