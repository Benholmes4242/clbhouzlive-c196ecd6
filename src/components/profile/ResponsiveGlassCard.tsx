    ...
    <>
      ...
      <div 
        className={`
          ...
          ${isMobile 
            ? 'mx-4 p-4 pb-8 scale-90' // Mobile: smaller scale, tighter margins, extra bottom padding
            : 'mx-auto max-w-md p-6 pb-12 scale-100' // Desktop: centered with breathing space, extra bottom padding
          }
        `}
        style={{
          ...glassStyles,
