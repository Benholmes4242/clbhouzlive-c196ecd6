...
const HeroProfileHeader = ({ 
  ...
  return (
    <SwipeToReturnZone onSwipeDown={reopenImmersive}>
      ...
      {isMobile ? (
        <div className="relative -mt-16 bg-white">
          <section className="relative w-full overflow-visible">
            ...
            {/* Glass panel with integrated content */}
            <div 
              ref={profileCardRef}
              className="absolute left-0 right-0 bottom-[-20px] md:bottom-[-28px] w-full z-10"
            >
              <GlassmorphicProfileCard
                ...
                recentlyFollowedBy={[]}
              >
                {/* Tabs integrated within the glass panel */}
                <ProfileTabs
        ...
        <div className="relative -mt-16 bg-white">
          <section className="relative w-full overflow-visible">
            ...
            <div 
              ref={profileCardRef}
              className="absolute left-1/2 -translate-x-1/2 bottom-[-20px] md:bottom-[-28px] w-[90%] md:w-full z-10"
            >
              <GlassmorphicProfileCard
                profile={profile}
                isOwnProfile={isOwnProfile}
      ...
      {/* Tab navigation is now integrated within the glass panel */}
