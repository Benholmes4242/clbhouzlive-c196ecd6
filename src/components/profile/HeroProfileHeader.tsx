                ...
                <div className="mt-4 w-full max-w-sm mx-auto">
                  <div className="grid grid-cols-2 gap-4">
                      <div className="text-center">
                        ...
                        <div className="mt-1 text-base font-medium text-gray-900 leading-tight">
                          <div className="flex flex-wrap justify-center gap-x-1 max-w-[100px] mx-auto">
                            {homeClub.split(' ').map((word, index, words) => (
                              <span 
                                key={index}
                                className={`${index > 0 && index % 2 === 0 ? 'basis-full' : ''}`}
                              >
                                {word}
                              </span>
                            ))}
                ...
                <div className="mt-5 w-full max-w-md mx-auto">
                  <div className="grid grid-cols-2 gap-4">
                     <div className="text-center">
                       ...
                       <div className="mt-1 text-lg font-medium text-gray-900 leading-tight">
                         <div className="flex flex-wrap justify-center gap-x-1 max-w-[120px] mx-auto">
                           {homeClub.split(' ').map((word, index, words) => (
                             <span 
                               key={index}
                               className={`${index > 0 && index % 2 === 0 ? 'basis-full' : ''}`}
