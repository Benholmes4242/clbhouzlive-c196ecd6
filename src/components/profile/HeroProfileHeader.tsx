  ...
  return (
    <>
      ...
      <div className="relative w-full">
        ...
        <div 
          className="absolute inset-0 w-full h-[920px] overflow-hidden"
          style={{
        ...
        <div className="relative z-10 flex flex-col items-center text-center pt-20 pb-8">
          ...
          <div className="w-full max-w-md">
            <div className="bg-white/5 backdrop-blur-2xl border border-white/20 shadow-[0_0_20px_rgba(0,0,0,0.2)] rounded-full py-2" style={{ backdropFilter: 'blur(40px) saturate(180%)' }}>
