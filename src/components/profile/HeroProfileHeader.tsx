        ...
        <div className="relative -mt-16 bg-white">
          <section className="relative w-full overflow-visible">
            ...
            <div 
              ...
              "
            >
               <div className="px-5 pt-2 pb-12 flex flex-col items-center relative">
        ...
        <div className="relative -mt-16 bg-white">
          <section className="relative w-full overflow-visible">
            ...
            <div 
              ...
              "
            >
               <div className="px-8 pt-6 pb-14 flex flex-col items-center relative">
                  {/* Three dots menu - positioned absolutely on left */}
                  {isOwnProfile && (
