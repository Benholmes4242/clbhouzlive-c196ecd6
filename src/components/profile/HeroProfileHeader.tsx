        ...
        <div className="absolute bottom-0 left-0 right-0 z-40 flex flex-col items-center text-center pb-8 px-4">
          ...
          <div className="text-center mb-6">
            ...
            <div className="flex items-center justify-center">
              <h1 className="font-bold text-black text-4xl" style={{ textShadow: '0 1px 3px rgba(0, 0, 0, 0.3)' }}>
                {displayName}
              </h1>
            </div>
            ...
            {username && (
              <div className="flex items-center justify-center gap-3 mb-2">
                <p className="text-lg text-gray-700" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.2)' }}>
                  @{username}
                </p>
            ...
            {/* Home Golf Club */}
            <p className="text-base text-gray-600" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.2)' }}>
              {homeClub}
            </p>
          </div>
