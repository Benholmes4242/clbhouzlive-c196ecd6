            ...
            >
               <div className="px-5 py-4 flex flex-col items-center relative">
                  ...
                  <div className="mt-4 w-full flex items-center justify-between">
                    ...
                    <div className="w-20 h-24 rounded-lg flex flex-col items-center justify-center p-2 ml-4 overflow-hidden">
                      <div className="w-14 h-14 rounded-md overflow-hidden border border-white/40 mb-1">
                        {profile?.profile_photo_url ? (
                          <img
                            src={profile.profile_photo_url}
                            alt="Mini profile"
            ...
            >
               <div className="px-8 py-10 flex flex-col items-center relative">
                  ...
                  <div className="mt-5 w-full flex items-center justify-between">
                    ...
                    {/* Right side - Mini Profile Card (vertical rounded rectangle) */}
                    <div className="w-22 h-28 rounded-lg flex flex-col items-center justify-center p-2 ml-6 overflow-hidden">
