...
const HeroProfileHeader = ({ 
  ...
  return (
    <>
      {/* White background */}
      <div className="fixed top-0 left-0 right-0 w-full h-screen bg-white overflow-hidden z-0" />
      ...
      <div className="relative w-full min-h-screen z-10">
        ...
        <div className="relative flex items-end justify-between pb-12 pt-32">
          ...
          {isOwnProfile && (
            <div className="flex flex-col space-y-2 items-end justify-end">
              <button 
                className="bg-black/40 backdrop-blur-sm border border-black/20 text-white px-3 py-1.5 shadow-lg transition-colors text-base font-medium"
        ...
        <div className="relative mb-6">
          <div className="bg-black/40 backdrop-blur-sm border border-black/20 px-6 py-1 shadow-lg" style={{ borderRadius: '8px' }}>
        ...
        >
            ...
            {activeSection === 'handicap' && (
              <div className="mt-8 px-0">
                ...
                <div className="bg-black/40 backdrop-blur-sm border border-black/20 shadow-lg p-6" style={{ borderRadius: '8px' }}>
                  <HandicapSection 
                    userId={profile?.id || ''}
                    profile={profile}
                  />
