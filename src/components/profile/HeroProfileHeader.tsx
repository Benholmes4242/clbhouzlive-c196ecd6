      ...
      {isMobile ? (
        <div className="relative -mt-16 bg-white">
          <section className="relative w-full overflow-visible">
            ...
            <section
              ref={profileCardRef}
              className="relative z-20 mx-0 sm:mx-0 md:mx-0 lg:mx-4 rounded-none lg:rounded-2xl border border-white/35 bg-white/50 backdrop-blur-xl shadow-[0_10px_30px_rgba(0,0,0,0.15)]"
