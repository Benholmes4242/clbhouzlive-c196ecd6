               ...
               <div className="px-5 py-4 flex flex-col items-center relative">
                  ...
                  <div className="w-full mb-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="w-[84px] h-[112px] rounded-lg border border-white/40 bg-white/20 backdrop-blur-sm shadow-sm overflow-hidden ml-4 mt-10 flex-shrink-0">
                        {profile?.profile_photo_url ? (
                          <img
                            src={profile.profile_photo_url}
                            alt="Mini profile"
               ...
               <div className="px-8 py-6 flex flex-col items-center relative">
                  ...
                  <div className="w-full mb-4">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="w-[112px] h-[149px] rounded-lg border border-white/40 bg-white/20 backdrop-blur-sm shadow-sm overflow-hidden ml-6 mt-10 flex-shrink-0">
                        {profile?.profile_photo_url ? (
                          <img
                            src={profile.profile_photo_url}
                            alt="Mini profile"
