...
> = {
  ...
  uncommon: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep:
      'linear-gradient(150deg, rgba(59,130,246,0.18) 0%, #FFFFFF 60%)',
    topStripe: null,
    glow: null,
  ...
  rare: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep:
      'linear-gradient(150deg, rgba(247,147,30,0.18) 0%, #FFFFFF 60%)',
    topStripe: null,
    glow: null,
  ...
  epic: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep:
      'linear-gradient(150deg, rgba(168,85,247,0.18) 0%, #FFFFFF 60%)',
  ...
  legendary: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep:
      'linear-gradient(150deg, rgba(247,147,30,0.24) 0%, #FFF8EA 50%, #FFFFFF 100%)',
  ...
  bronze: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(150deg, rgba(205,127,50,0.20) 0%, #FFFFFF 60%)',
  ...
  emerald: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(150deg, rgba(16,185,129,0.20) 0%, #FFFFFF 60%)',
  ...
  diamond: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(150deg, rgba(125,211,252,0.22) 0%, #FFFFFF 60%)',
