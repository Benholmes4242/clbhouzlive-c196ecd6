...
> = {
  ...
  bronze: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(135deg, var(--hcp-bg-1) 0%, #151B23 50%, rgba(205,127,50,0.18) 100%)',
  ...
  silver: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(135deg, var(--hcp-bg-1) 0%, #151B23 50%, rgba(192,192,200,0.18) 100%)',
  ...
  emerald: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(135deg, var(--hcp-bg-1) 0%, #0F1E1A 50%, rgba(16,185,129,0.22) 100%)',
  ...
  diamond: {
    ...
    cardBg: 'var(--hcp-bg-1)',
    cardSweep: 'linear-gradient(135deg, var(--hcp-bg-1) 0%, #1E1B2E 50%, rgba(125,211,252,0.22) 100%)',
