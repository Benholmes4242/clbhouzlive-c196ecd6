    ...
    <div className="w-full max-w-[1200px] mx-auto">
      <div className={`w-full flex flex-col bg-background`}>
        ...
        <div className="w-full" style={{ paddingTop: isMobile ? '0px' : '0px', paddingBottom: isMobile ? '130px' : '60px' }}>
          ...
          {isMobile && (
            <div className="flex justify-center items-center px-2 pb-6">
              <div className="flex items-center gap-6 w-full max-w-[360px] mx-auto">
                          ...
                          {!isActive && (
                            <div className="absolute inset-0 flex items-center justify-center">
                              <img 
                                src={padlockIcon} 
                                alt="Locked" 
                                className={`${isMobile ? 'w-2 h-2' : 'w-4 h-4'} opacity-60 drop-shadow-none`}
                           ...
                           {!isActive && (
                               <div className="absolute inset-0 flex items-center justify-center">
                                 <img 
                                   src={padlockIcon} 
                                   alt="Locked" 
                                   className={`${isMobile ? 'w-6 h-6' : 'w-8 h-8'} opacity-60 drop-shadow-none`}
                                   style={{ filter: 'none', background: 'transparent' }}
                                 />
                              </div>
                           )}
                                      ...
                                      {!achievement.isEarned && (
                                         <div className="absolute inset-0 flex items-center justify-center">
                                           <img 
                                             src={padlockIcon} 
                                             alt="Locked" 
                                              className={`${isMobile ? 'w-12 h-12' : 'w-14 h-14'} opacity-60 drop-shadow-none`}
                                             style={{ filter: 'none', background: 'transparent' }}
                                           />
                                        </div>
                                      )}
