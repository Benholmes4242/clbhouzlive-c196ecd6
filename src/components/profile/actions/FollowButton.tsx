...
const FollowButton: React.FC<FollowButtonProps> = ({
  ...
  return (
    <Button
      ...
      onClick={onFollow}
      disabled={loading}
      className="px-4 py-2 text-sm h-8 flex-shrink-0 bg-white/20 hover:bg-white/30 text-white hover:text-white backdrop-blur-sm rounded-full border border-white/20"
    >
      {getButtonIcon()}
