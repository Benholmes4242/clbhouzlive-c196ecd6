...
const ProfileTabs: React.FC<ProfileTabsProps> = ({
  ...
  return (
    <div className="w-full">
      {/* Tab Bar */}
      <div className="relative z-50 bg-background backdrop-blur-sm w-full">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex-1 flex items-center justify-center pt-4 pb-0 transition-all duration-200 relative ${
                    isActive 
                      ? 'text-foreground' 
      ...
      {/* Tab Content */}
      <div className={`pt-20 pb-1 ${activeTab === 'activity' ? 'md:px-0' : activeTab === 'achievements' ? 'px-0' : 'px-4 md:px-0'}`}>
