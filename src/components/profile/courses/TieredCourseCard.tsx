        ...
        <div className="flex">
          ...
          <div className="relative flex-shrink-0">
            {course.thumbnail_image ? (
              ...
              <div <div className="w-24 h-full bg-gradient-to-br from-muted to-muted/50 rounded-l-xl" /> />
            )}
    ...
    >
      <div className="flex">
        ...
        {course.thumbnail_image ? (
          ...
          <div <div className="w-[72px] h-full bg-muted flex-shrink-0 rounded-l-xl" /> />
        )}
