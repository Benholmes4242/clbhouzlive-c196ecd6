...
// Size configurations - outer size, then 1.5px ring, 1px white gap, then avatar (reduced 20% total)
const SIZES = {
  sm: { outer: 79, white: 77, avatar: 76 },
  md: { outer: 107, white: 104, avatar: 103 },
  lg: { outer: 145, white: 142, avatar: 141 },
};
