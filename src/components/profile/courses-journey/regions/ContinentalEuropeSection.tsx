...
const ContinentalEuropeNavigation: React.FC<RegionNavigationProps> = ({ 
  userId,
  isOwnProfile = false
}) => {
...
// Section Component
const ContinentalEuropeSection: React.FC<RegionSectionProps> = ({ 
  userId,
  isOwnProfile = false,
  userDisplayName
}) => {
...
export default ContinentalEuropeConditionalSection;
