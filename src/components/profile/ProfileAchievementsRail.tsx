 ...
 * 
 * Uses SDS-compliant AchievementBadgeCard with canonical sizing
 */
  ...
  return (
    <>
      ...
      >
        ...
        {/* Horizontal scroll strip - cards use SDS tokens for sizing */}
        <div className="flex gap-3 overflow-x-auto pb-2 pt-2 [-webkit-overflow-scrolling:touch] scrollbar-hide -mx-4 px-4">
          {visible.map((ach, index) => (
            <div key={ach.id} className="shrink-0" style={{ width: '160px' }}>
