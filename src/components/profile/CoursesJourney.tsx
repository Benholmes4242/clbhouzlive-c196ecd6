...
const CoursesJourney: React.FC<CoursesJourneyProps> = ({ 
  ...
  return (
    <div className={`w-full pt-8 ${className}`}>
      ...
      {/* Courses Played Section with Regional Carousels */}
      <CoursesPlayedSection userId={userId} isOwnProfile={isOwnProfile} />
...
// Courses Played Section Component with Regional Carousels
