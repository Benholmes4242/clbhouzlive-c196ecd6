    ...
    <div>
      ...
      <div className="mb-5">
        ...
        {isGolfClub && clubLocation ? (
          <div className="flex items-center gap-2 h-12 px-4 bg-muted border border-border rounded-xl text-sm text-muted-foreground">
            <MapPin className="w-4 h-4" />
            <span className="flex-1">{clubLocation}</span>
            <span className="text-xs text-muted-foreground">From club data</span>
          </div>
        ) : (
