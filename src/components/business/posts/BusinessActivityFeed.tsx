  ...
  if (tab === 'activity') {
    return (
      <div className="py-12 text-center">
        ...
        {canManage && (
          <button
            className="rounded-lg bg-card hover:bg-muted text-foreground border border-border/60 px-6 py-3 min-h-[44px] text-sm font-semibold transition-colors active:scale-[0.97]"
