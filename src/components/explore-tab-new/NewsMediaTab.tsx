...
export function NewsMediaTab({ onOpenPost }: { onOpenPost: (items: CommunityLibraryItem[], item: CommunityLibraryItem, source: string) => void }) {
  ...
  return (
    <main style={{ paddingTop: 'var(--discover-header-h)', minHeight: '100dvh', background: A.CANVAS, color: A.INK, fontFamily: SANS }}>
      <section style={{ minHeight: 216, padding: '34px 20px 18px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', borderBottom: `1px solid ${A.BORDER}` }}>
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 0, color: A.MUTE, marginBottom: 9 }}>THE AMATEUR GAME</div>
