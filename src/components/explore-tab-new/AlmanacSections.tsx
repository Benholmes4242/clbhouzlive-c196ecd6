...
import { useRegionFeats, sortBirdieHauls, type FeatTier, type RecordsMode } from './hooks/useRegionFeats';
...
// ---- THE LENS ----
// Single sticky control bar: region chips (scrollable) + scope segment.
// One toggle governs the page; sheets receive scope via initialMode.

interface LensProps extends Props {
  scope: RecordsMode;
