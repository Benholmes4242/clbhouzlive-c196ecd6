  ...
  "inline-flex items-center justify-center gap-2 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "rounded-sq-sm bg-white border border-[#E0E0E0] text-foreground hover:bg-slate-50 active:bg-slate-100",
        "gradient-primary": "rounded-sq-sm bg-white border border-[#E0E0E0] text-foreground hover:bg-slate-50 active:bg-slate-100",
