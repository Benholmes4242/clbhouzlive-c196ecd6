  ...
  "inline-flex items-center justify-center gap-2 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        tertiary: "rounded-xl border border-border/60 bg-card text-xs font-medium text-foreground shadow-[0_1px_3px_rgba(0,0,0,0.06)] hover:bg-slate-100 active:bg-slate-100 active:scale-[0.98]",
        ...
        outline: "rounded-xl bg-white border border-slate-600 text-slate-600 hover:bg-slate-50 active:bg-slate-100",
        ghost: "rounded-xl bg-transparent text-slate-600 hover:bg-slate-50",
        link: "text-slate-600 underline-offset-4 hover:underline",
        gradient: "rounded-xl bg-white border border-slate-600 text-slate-600 hover:bg-slate-50 active:bg-slate-100",
        "gradient-primary": "rounded-xl bg-white border border-slate-600 text-slate-600 hover:bg-slate-50 active:bg-slate-100",
        ...
        glass: "rounded-xl bg-white/90 backdrop-blur-md border border-black/10 shadow-sm text-gray-900 font-medium hover:bg-white hover:scale-[1.02] active:translate-y-[1px] disabled:opacity-60 disabled:cursor-not-allowed",
        "glass-outline": "rounded-xl bg-white/70 backdrop-blur-md border border-black/15 shadow text-gray-900 font-medium hover:bg-white/80 hover:scale-[1.02] active:translate-y-[1px]",
      },
      size: {
