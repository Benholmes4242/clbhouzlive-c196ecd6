...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card text-card-foreground border-border/10 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-500 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        bottom:
          "inset-x-0 bottom-0 border-t max-h-[85dvh] overflow-hidden flex flex-col data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
