...
export const VideoIcon: React.FC<VideoIconProps> = ({ show, iconType = 'play' }) => {
  ...
  return (
    <div className="absolute bottom-2 right-3 flex items-center justify-center w-10 h-10 text-white hover:bg-white/10 rounded-full transition-colors pointer-events-auto z-20">
