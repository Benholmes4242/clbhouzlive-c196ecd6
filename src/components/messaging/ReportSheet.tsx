           ...
           <div className="space-y-2">
             {REPORT_REASONS.map((reason) => (
               ...
               >
                 ...
                 {selectedReason === reason.id && (
                   <div className="ml-auto w-5 h-5 rounded-full bg-[#2A9D5C] flex items-center justify-center">
           ...
           {selectedReason && (
             <div className="space-y-2">
               ...
               <Textarea
                 ...
                 className="min-h-[80px] resize-none rounded-2xl border-[#E5E5EA]"
               />
             </div>
           )}
