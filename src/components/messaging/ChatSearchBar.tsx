 ...
 export function ChatSearchBar({
   ...
   return (
     <div className="flex items-center gap-2 px-4 py-2 bg-white border-b border-[#E5E5EA]">
       {/* Search input */}
       <div className="relative flex-1">
         ...
         <Input
           ...
           className="pl-10 pr-4 h-9 rounded-full bg-[#F5F5F5] border-0 text-sm"
           autoFocus
         />
       </div>
       ...
       <button
         onClick={onClose}
         className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-[#F5F5F5] active:bg-[#E5E5EA]"
       >
