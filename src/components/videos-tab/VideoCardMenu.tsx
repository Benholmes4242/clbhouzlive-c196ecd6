...
import { MoreHorizontal, Bookmark, Link2, Share2, EyeOff, Flag, Ban } from 'lucide-react';
...
interface VideoCardMenuProps {
  postId: string;
  userId?: string;
  /** Post author's user id — required to enable the Block action. */
...
export const VideoCardMenu = React.memo(function VideoCardMenu({
  postId,
  userId,
  authorUserId,
  authorUsername,
