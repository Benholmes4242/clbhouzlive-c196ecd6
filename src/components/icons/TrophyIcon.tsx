...
/**
 * Tour mark — SOLID (Ben, 14 Sep: every nav icon is a filled shape).
 *
 * The icon set's own fill-weight drawing: the cup body is solid, the two handles
 * keep their counters so the trophy is still legible at 23px.
 */
