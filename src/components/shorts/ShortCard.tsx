      ...
      >
        ...
        {isLandscape ? (
          ...
          <div className="absolute bottom-3 right-0 z-10 pointer-events-none">
            ...
            {/* Avatar squircle - positioned 16px from right edge, 90% overlaps panel, 10% extends above */}
            <div
              className="absolute right-4 bottom-4 w-[56px] h-[56px] rounded-[14px] overflow-hidden border border-white/30 bg-black/40 backdrop-blur-md"
              style={{
