...
export default function UnifiedWatchFeed({ embedded = false }: UnifiedWatchFeedProps) {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#F8FAFC' }}>
      ...
      <div style={{ padding: '12px 0 0', background: '#F8FAFC', position: 'sticky', top: '100px', zIndex: 20 }}>
        <div
      ...
      <div>
        <SectionHeader eyebrow="Long-form" title="Latest videos" onSeeAll={() => navigate('/watch/videos')} paddingTop={26} />
