  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        {/* Gradient overlays for visual scroll indication - mobile only */}
        {!isAtStart && (
          <div className="absolute left-0 top-0 h-full w-8 bg-gradient-to-r from-white/60 to-transparent pointer-events-none z-10 md:hidden" />
        )}
        {!isAtEnd && (
          <div className="absolute right-0 top-0 h-full w-8 bg-gradient-to-l from-white/60 to-transparent pointer-events-none z-10 md:hidden" />
        )}
      </div>
    </div>
  );
