        ...
        >
          ...
          <AnimatePresence>
            {!isDetailExpanded && (
              ...
              >
                <div 
                  className="text-white font-medium text-center text-xs px-3 py-1.5 rounded-xl cursor-pointer hover:scale-105 transition-transform duration-200 line-clamp-2 leading-tight max-w-[130px]"
                  style={{ 
