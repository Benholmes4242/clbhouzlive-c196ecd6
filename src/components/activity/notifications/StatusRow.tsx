...
import {
  CheckCircle2, Clock, Ban, Building2, Flag, UserPlus, Users,
} from 'lucide-react';
...
function iconFor(type: string) {
  ...
  if (type === 'business_team_invited') return UserPlus;
  if (type === 'business_team_joined') return CheckCircle2;
  if (type === 'business_team_member_joined') return Users;
...
function toneFor(type: string): { fg: string; bg: string } {
  ...
  if (type === 'business_team_invited') return { fg: '#F7931E', bg: 'rgba(247,147,30,0.10)' };
  if (type === 'business_team_joined' || type === 'business_team_member_joined') return { fg: '#16A34A', bg: 'rgba(22,163,74,0.10)' };
