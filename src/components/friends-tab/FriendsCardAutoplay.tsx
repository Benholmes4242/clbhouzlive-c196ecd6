...
interface FriendsCardAutoplayProps {
  hlsUrl: string;
  posterUrl: string;
  isEligible: boolean;
  cardIndex: number;
...
export function FriendsCardAutoplay({ hlsUrl, posterUrl, isEligible, cardIndex }: FriendsCardAutoplayProps) {
    ...
    try {
      ...
      if (Hls.isSupported()) {
        ...
        hls.on(Hls.Events.MANIFEST_PARSED, () => {
          hls.currentLevel = 0;
          video.play().catch((e) => console.warn('[FriendsCardAutoplay] play() rejected:', e.message));
        });
