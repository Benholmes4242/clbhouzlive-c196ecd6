  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
        <div className="rounded-sq-sm border border-white/40 bg-white/75 backdrop-blur-md shadow-sm p-4 sm:p-5">
          {/* Label pill */}
          <div className="mb-3">
            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-wide uppercase text-slate-600 bg-slate-100/80 px-3 py-1.5 rounded-sq-pill border border-slate-200/60">
          ...
          <div className="flex items-center gap-2.5">
            {displayCourse.globalRank && (
              <span className="text-xs font-semibold text-slate-700 bg-slate-100 px-3 py-1.5 rounded-sq-xs border border-slate-200/80 shadow-sm">
                #{displayCourse.globalRank} Global
              </span>
            )}
            {displayCourse.regionalRank && displayCourse.region && (
              <span className="text-xs font-medium text-slate-600 bg-slate-50 px-3 py-1.5 rounded-sq-xs border border-slate-200/60">
                #{displayCourse.regionalRank} {displayCourse.region}
              </span>
            )}
          </div>
