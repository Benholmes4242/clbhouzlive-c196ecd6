...
export const PromotionStatusBanner: React.FC<PromotionStatusBannerProps> = ({
  ...
  if (justPromotedRecently && newDivisionName) {
    return (
      <div className="flex items-center gap-3 px-4 py-3 bg-amber-50 rounded-xl w-full">
  ...
  if (isInPromotionZone) {
    return (
      <div className="flex items-center gap-3 px-4 py-3 bg-emerald-50 rounded-xl w-full">
  ...
  if (distanceToPromotion > 0 && distanceToPromotion <= 3) {
    return (
      <div className="flex items-center gap-3 px-4 py-3 bg-blue-50 rounded-xl w-full">
