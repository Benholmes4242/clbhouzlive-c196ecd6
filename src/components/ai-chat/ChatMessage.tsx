      ...
      <div className={cn(
        ...
        >
          ...
          <div 
            ...
            className={cn(
              "text-body-md relative overflow-hidden backdrop-blur-[var(--glass-blur)] bubble-prose rounded-[var(--bubble-radius)]",
              isUser 
                ...
                <div>
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      h1: ({ children }) => <h3 className="text-body-md font-semibold mb-2 mt-[10px] first:mt-0 text-white">{children}</h3>,
                      h2: ({ children }) => <h4 className="text-body-md font-semibold mb-2 mt-[10px] text-white">{children}</h4>,
                      h3: ({ children }) => <h4 className="text-body-md font-semibold mb-[6px] mt-[10px] text-white">{children}</h4>,
                        ...
                        >
                          <div className="flex items-center justify-between px-3 py-1.5 border-b border-white/10">
                            ...
                            <button
                              ...
                              className="text-meta text-white/60 hover:text-white/90 px-2 py-0.5 rounded hover:bg-white/5 transition-colors focus:outline-none focus:ring-2 focus:ring-white/30"
                            >
                              Copy
                            </button>
                          </div>
