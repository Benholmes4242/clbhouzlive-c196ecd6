                ...
                <div className="space-y-1">
                  ...
                  {isLoading && (
                    <div className="mt-4">
                      ...
                      {/* Loading bubble */}
                      <div className="rounded-2xl border overflow-hidden backdrop-blur-[var(--glass-blur)]"
                        style={{
                  ...
                  {messages.map((message, index) => {
                    ...
                    <div className="mt-4 px-4 flex items-end gap-2">
                      ...
                      <div className="flex-1">
                        <div className="rounded-2xl bg-white/05 border border-white/12 shadow-[0_10px_28px_rgba(0,0,0,0.4)] px-3 py-2">
                          <div className="flex items-center gap-1.5">
