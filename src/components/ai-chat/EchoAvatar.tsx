    ...
    <Squircle width={size} height={size}>
      <div
        style={{
          ...
          border: '1px solid hsl(var(--background) / 0.55)',
          position: 'relative',
          overflow: 'hidden'
        }}
      >
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(180deg, hsl(var(--background) / 0.3) 0%, hsl(var(--background) / 0.15) 50%, transparent 100%)',
            opacity: 0.8,
            pointerEvents: 'none'
          }}
        />
        ...
        <PiWaveform 
          size={getIconSize()} 
          className="text-foreground/80 transition-all duration-200 ease-in-out"
          style={{
