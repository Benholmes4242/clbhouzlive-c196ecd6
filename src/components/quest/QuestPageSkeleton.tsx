...
export const QuestPageSkeleton: React.FC = () => (
  <div className="min-h-screen bg-[#F8FAFC]">
    ...
    <div className="px-4 pt-4 pb-2">
      <div className="w-16 h-4 rounded bg-slate-200 animate-pulse mb-5" />
      <div className="flex flex-col items-center">
        <div className="w-48 h-8 rounded bg-slate-200 animate-pulse mb-2" />
    ...
    <div className="px-4 pt-6 pb-8">
      <div className="flex flex-col items-center">
        <div className="w-28 h-7 rounded-full bg-slate-200 animate-pulse mb-6" />
        <div className="w-[72px] h-[72px] rounded-2xl bg-slate-200 animate-pulse mb-6" />
        <div className="w-40 h-14 rounded bg-slate-200 animate-pulse mb-2" />
        <div className="w-48 h-4 rounded bg-slate-200 animate-pulse mb-5" />
        <div className="w-56 h-2.5 rounded-full bg-slate-200 animate-pulse mb-4" />
        <div className="w-40 h-10 rounded-full bg-slate-200 animate-pulse" />
      </div>
    </div>
    ...
    <div className="px-4 mb-10">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="w-40 h-8 rounded-full bg-slate-200 animate-pulse" />
      </div>
    ...
    <div className="px-4 mb-10">
      <div className="w-24 h-4 rounded bg-slate-200 animate-pulse mb-4" />
    ...
    <div className="px-4 mb-12">
      <div className="w-28 h-4 rounded bg-slate-200 animate-pulse mb-4" />
      <div className="bg-white rounded-2xl p-4 border border-slate-200">
    ...
    <div className="px-4 mb-12">
      <div className="w-32 h-4 rounded bg-slate-200 animate-pulse mb-4" />
      <div className="space-y-4">
        {[1, 2, 3, 4].map(i => (
