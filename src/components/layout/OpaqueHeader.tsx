  ...
  return (
    ...
    >
      {onBack ? (
        <button
          onClick={onBack}
          className="flex items-center gap-1 text-foreground/90 hover:text-foreground text-[15px] font-medium transition-colors -ml-1"
          aria-label="Back"
        >
      ...
      <h1 className="text-foreground/90 text-[17px] font-semibold">
        {title}
      </h1>
