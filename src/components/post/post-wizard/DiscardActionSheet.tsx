          ...
          >
            ...
            <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl overflow-hidden mb-2 shadow-xl">
              ...
              <button
                onClick={onDiscard}
                disabled={isSaving}
                className="w-full py-4 text-center text-red-500 text-lg font-normal border-b border-gray-200/50 dark:border-gray-700/50 active:bg-gray-100 dark:active:bg-gray-800 disabled:opacity-50 transition-colors"
              >
                Discard
              </button>
              ...
              {canSaveDraft && (
                <button
                  ...
                  disabled={isSaving}
                  className="w-full py-4 text-center text-blue-500 text-lg font-normal active:bg-gray-100 dark:active:bg-gray-800 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                >
                  {isSaving ? (
                    <>
