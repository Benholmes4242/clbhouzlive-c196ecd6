...
export function CaptionStep({ 
  ...
  const counterClass = useMemo(() => {
    ...
    if (charPercent >= 0.8) return 'text-primary';
      ...
      <div className="flex flex-col py-4 pb-32">
            ...
            <button onClick={handleEditMedia} className="flex items-center gap-2 group">
              {previewMedia.map((item, idx) => (
                <div key={item.id} className={cn(
                  ...
                  idx === 0 ? "w-14 h-14 ring-2 ring-primary scale-105" : "w-12 h-12"
                )}>
                  <img
                    src={item.previewUrl}
                    alt=""
          ...
          <div className="mt-2">
            <Textarea
              ...
              style={{
                color: '#1f2937',
                border: 'none',
                borderBottom: `2px solid ${isFocused ? 'hsl(var(--primary))' : 'transparent'}`,
                outline: 'none',
                boxShadow: 'none',
              ...
              <div className="pt-2 flex flex-wrap items-center gap-1.5 mt-2">
                ...
                {state.selectedTags.map(tag => (
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium transition-colors bg-muted text-foreground hover:bg-muted/80"
                  >
              ...
              <div className="flex items-center justify-end gap-1.5 pt-2">
                <svg className="w-4 h-4" viewBox="0 0 16 16">
                  ...
                  <circle
                    ...
                    stroke={charPercent >= 0.95 ? '#ef4444' : 'hsl(var(--primary))'}
                    strokeWidth="2"
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-dashed border-border hover:border-primary/40 hover:text-foreground transition-colors text-left"
          >
        ...
        >
          ...
          >
            <Tag className={cn(
              ...
              hasCategories ? "text-primary" : "text-gray-400"
            )} />
            {hasCategories ? (
              <div className="flex-1 flex flex-wrap gap-1.5 min-w-0">
                {state.selectedCategories.slice(0, 3).map((cat) => (
                  <span 
                    ...
                    className="px-2.5 py-0.5 text-xs rounded-full bg-primary text-primary-foreground font-medium"
                  >
