...
export function ConfirmStep({ 
  ...
  return (
    <div className="h-full flex flex-col overflow-y-auto" style={{ background: 'linear-gradient(to bottom, rgba(254,243,199,0.15), rgba(254,243,199,0.08) 30%, white 50%, white)' }}>
