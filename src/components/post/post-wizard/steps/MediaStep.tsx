...
export function MediaStep({ 
  ...
  if (!hasMedia) {
    ...
    return (
      <div className="h-full flex flex-col items-center justify-center px-8 relative" style={{ background: 'linear-gradient(to bottom, rgba(254,243,199,0.15), rgba(254,243,199,0.08) 30%, white 50%, white)' }}>
  ...
  return (
    <div className="h-full flex flex-col relative" style={{ background: 'linear-gradient(to bottom, rgba(254,243,199,0.15), rgba(254,243,199,0.08) 30%, white 50%, white)' }}>
