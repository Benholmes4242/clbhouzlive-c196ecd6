...
export function PermissionDeniedCard({ type, onRetry }: PermissionDeniedCardProps) {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-300" style={{ background: 'linear-gradient(to bottom, rgba(254,243,199,0.15), rgba(254,243,199,0.08) 30%, white 50%, white)' }}>
