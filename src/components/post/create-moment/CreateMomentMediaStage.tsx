...
export default function CreateMomentMediaStage({
  ...
  return (
    ...
    >
      ...
      <div ref={stageContainerRef} className="flex-1 min-h-0 relative overflow-hidden" style={{ background: 'transparent', border: '3px solid red' }} data-ecm-no-dismiss="true">
        {/* Media container wrapper for drag calculations */}
        <div ref={mediaContainerRef} className="relative h-full w-full flex items-center justify-center" style={{ background: 'transparent', border: '3px solid blue' }}>
            <MediaCarousel
              ref={carouselRef}
