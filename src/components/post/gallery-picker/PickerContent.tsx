    ...
    <div className="space-y-2">
      {isMobile && (
        <Button
          ...
          className="w-full h-9 px-3 bg-white border border-gray-300 text-gray-700 hover:border-gray-400 transition-all duration-200 rounded-lg flex items-center gap-2 cursor-pointer text-xs font-medium"
        >
