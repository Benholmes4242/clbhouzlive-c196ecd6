// Post Studio Design Tokens — Single source of truth
// Light mode — standard Clbhouz light surface (#F8FAFC)

// Background layers
export const BG_BASE     = '#F8FAFC';
export const BG_CARD     = 'rgba(0,0,0,0.030)';
...
export const TEXT_SECONDARY = 'rgba(15,23,42,0.50)';
export const TEXT_TERTIARY  = 'rgba(15,23,42,0.30)';
...
export const ICON_COLOR = 'rgba(15,23,42,0.65)';
