// MentionPanel — @mention search, light bottom sheet
...
import { DARK_TEXT, DARK_TEXT2, DARK_TEXT3, DARK_CARD, DARK_BORDER, COMPOSE_BG } from '../tokens';
    ...
    <>
      ...
      >
        ...
        <div className="px-5 pb-3">
          <div className="flex items-center gap-2.5" style={{ background: 'rgba(15,23,42,0.04)', border: '1px solid rgba(15,23,42,0.08)', borderRadius: 14, padding: '11px 14px' }}>
            ...
            <input
              ...
              style={{ color: DARK_TEXT, caretColor: '#F7931E', fontSize: 16 }}
            />
            {query.length > 0 && (
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-6" style={{ scrollbarWidth: 'none' }}>
          ...
          {results.map((entity, i) => (
            <motion.button
              ...
              style={{ borderBottom: i < results.length - 1 ? '0.5px solid rgba(15,23,42,0.07)' : 'none' }}
            >
              ...
              <span style={{ background: 'rgba(15,23,42,0.05)', border: '1px solid rgba(15,23,42,0.08)', borderRadius: 20, fontSize: 10, fontWeight: 600, color: 'rgba(15,23,42,0.45)', padding: '2px 8px' }}>
