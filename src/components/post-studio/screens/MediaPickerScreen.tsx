...
export function MediaPickerScreen() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 gap-6">
        ...
        {!hasMedia && (
          <div className="text-center space-y-3">
            ...
            <p className="text-foreground font-semibold text-lg">Share a moment</p>
      ...
      {/* Bottom action row */}
      <div className="flex items-center justify-around py-4 px-6 border-t border-border/50 shrink-0">
        <button
        ...
        <button
          onClick={() => fileInputRef.current?.click()}
          className="w-14 h-14 rounded-full bg-primary flex items-center justify-center min-h-[44px]"
          disabled={isProcessing}
        >
