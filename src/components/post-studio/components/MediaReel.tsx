...
// Active item has amber ring. Drag to reorder. + button to add more.
  ...
  return (
    ...
    >
          ...
          return (
            <motion.button
              ...
              className={`relative shrink-0 rounded-lg overflow-hidden transition-all ${
                isActive ? 'ring-2 ring-primary scale-110' : 'ring-1 ring-border/50'
              }`}
              style={{
                width: REEL_THUMB_SIZE,
                height: REEL_THUMB_SIZE,
              }}
            >
              <img
      ...
      {items.length < 10 && (
        <button
          onClick={onAddMore}
          className="shrink-0 rounded-lg border-2 border-dashed border-border/50 flex items-center justify-center"
          style={{
            width: REEL_THUMB_SIZE,
            height: REEL_THUMB_SIZE,
          }}
