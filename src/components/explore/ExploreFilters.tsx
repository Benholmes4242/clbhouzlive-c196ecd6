    ...
    return (
      <button
        ...
        className={`
          ...
          ${isActive 
            ? 'bg-[hsl(var(--brand-orange)_/_0.2)] border-[hsl(var(--brand-orange))]' 
            : 'bg-white border-black hover:bg-[hsl(var(--brand-orange)_/_0.2)] hover:border-[hsl(var(--brand-orange))] transition-all duration-200'
          }
        `}
      >
        {/* Icon */}
