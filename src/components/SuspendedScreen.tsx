  ...
  return (
    ...
    >
      <div style={{ maxWidth: 440, width: '100%', margin: '0 auto' }}>
        ...
        {suspension.reason ? (
          <div style={{ border: '1px solid rgba(248, 250, 252, 0.12)', background: surfaceWithAlpha(LIGHT_ROUTE_CANVAS, 0.04), borderRadius: 12, padding: '14px 16px', marginBottom: 24 }}>
