...
const TrendingCard = () => {
  ...
  if (loading || !trendingPost) {
    return (
      <div className="px-1 mb-6">
        <div className="w-full aspect-[8/3] bg-muted rounded-xl animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="px-1 mb-6">
      <div className="relative w-full aspect-[8/3] rounded-xl overflow-hidden bg-card border group">
        {/* Trending Pill */}
