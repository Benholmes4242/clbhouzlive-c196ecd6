...
const TrendingCard = () => {
  ...
  if (loading || !trendingPost) {
    return (
      <div className="px-1 mb-6">
        <div className="w-52 md:w-60 aspect-[3/4] bg-muted rounded-xl animate-pulse mx-auto" />
      </div>
    );
  }
  ...
  return (
    <div className="px-1 mb-6">
      <div className="relative w-52 md:w-60 aspect-[3/4] rounded-xl overflow-hidden bg-card border group mx-auto">
        {/* Trending Pill */}
