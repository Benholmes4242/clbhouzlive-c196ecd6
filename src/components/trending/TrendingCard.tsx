...
const TrendingCard = () => {
    ...
    return (
      <div className="px-1 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <div className="w-full aspect-square bg-muted animate-pulse hidden md:block" />
          <div className="w-full aspect-square bg-muted animate-pulse hidden md:block" />
        </div>
      </div>
    );
  ...
  const TrendingCardItem = ({ post, index }) => {
    ...
    return (
      <div ref={containerRef} className="relative w-full aspect-square overflow-hidden bg-card group" onClick={handleVideoClick}>
