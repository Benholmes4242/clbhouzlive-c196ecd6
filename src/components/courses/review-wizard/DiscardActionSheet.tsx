// Apple-style Action Sheet for Exit Review confirmation
// Matches Post Wizard style - two options: Exit, Keep Editing
...
export function DiscardActionSheet({
  ...
  // Different copy for new reviews vs edit mode
