  ...
  return (
    ...
    >
      {hasMedia ? (
        ...
        <div className="flex-1 flex flex-col px-4 pb-4 relative" style={{ background: 'linear-gradient(to bottom, rgba(254,243,199,0.15), rgba(254,243,199,0.08) 30%, white 50%, white)' }}>
          <button
            onClick={onClose}
