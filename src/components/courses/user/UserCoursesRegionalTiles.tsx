                  ...
                  <Tooltip key={tile.key}>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={`relative flex items-center justify-center gap-1 cursor-pointer transition-colors whitespace-nowrap py-1.5 shadow-lg shadow-black/10 text-base font-medium overflow-hidden h-12 ${
              ...
              {sortOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center gap-2 text-base font-medium whitespace-nowrap px-4 py-1.5 shadow-lg shadow-black/10 transition-colors overflow-hidden h-12 ${
                      sortBy === option.key 
                        ? "text-white" 
                        : "text-white hover:bg-white/20"
                    }`}
