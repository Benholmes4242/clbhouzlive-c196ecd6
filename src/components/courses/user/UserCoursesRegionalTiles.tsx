                  ...
                  <Tooltip key={tile.key}>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={`relative flex items-center justify-center gap-1 cursor-pointer transition-colors whitespace-nowrap px-0.5 py-1.5 shadow-lg shadow-black/10 text-base font-medium overflow-hidden ${
              ...
              {sortOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center gap-2 text-base font-medium whitespace-nowrap px-1 py-1.5 shadow-lg shadow-black/10 transition-colors overflow-hidden ${
                      sortBy === option.key 
                        ? "text-white" 
                        : "text-white hover:bg-white/20"
                    }`}
