                ...
                <div className="flex items-center space-x-3">
                  ...
                  {achievement.id === '20-club' ? (
                    <div className="w-10 h-10 flex items-center justify-center">
                      <MedalIcon size="xl" type="20-club" className="!w-28 !h-28" />
                    </div>
                  ) : achievement.id === '50-club' ? (
                    <div className="w-10 h-10 flex items-center justify-center">
                      <MedalIcon size="xl" type="50-club" className="!w-28 !h-28" />
                    </div>
                    ...
                    <div className="w-10 h-10 flex items-center justify-center">
                      <MedalIcon size="xl" type="300-club" className="!w-56 !h-56" />
                    </div>
                  ) : (
