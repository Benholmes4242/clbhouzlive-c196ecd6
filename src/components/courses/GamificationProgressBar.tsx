...
import MilestoneAchievements from '@/components/profile/MilestoneAchievements';
import RegionalCompletion from '@/components/profile/RegionalCompletion';
    ...
    <Tooltip.Provider>
      <div className={cn('space-y-6', className)}>
        ...
        <div className="bg-muted border border-border rounded-xl p-6 space-y-6 relative overflow-hidden">
          ...
          <MilestoneAchievements completedCount={completedCount} className="mb-8" />
          ...
          <div className="pt-8">
            <RegionalCompletion
              ...
              onRegionClick={(region) => {
                // Find the regional list to set as selected
                const selectedList = regionalProgress.lists.find(list => list.id === region);
                if (selectedList) {
                  setSelectedCourseList(selectedList);
