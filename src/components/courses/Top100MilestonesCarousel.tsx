...
export function Top100MilestonesCarousel({
  ...
  return (
    <section className="space-y-2">
      <h3 className="text-sm font-semibold text-foreground px-1">Milestones</h3>
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                {isNext && (
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-2 py-0.5 rounded-full bg-slate-900 text-[9px] font-medium text-white">
                    Next
                  </span>
                )}
              </div>
