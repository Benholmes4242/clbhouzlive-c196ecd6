      ...
      {distributionItems.map((item) => {
        ...
        return (
          <div key={item.key} className="flex items-center gap-2">
            ...
            {/* Bar track */}
            <div className="flex-1 h-[6px] rounded-full overflow-hidden" style={{ <div className="flex-1 h-[6px] rounded-full overflow-hidden" style={{ background: 'rgba(245,158,11,0.06)' }}> }}>
              <div
