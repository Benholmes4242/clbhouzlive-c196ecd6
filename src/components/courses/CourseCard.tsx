      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          ...
          {showXP && xp && (
           ...
           <h3 className={`${mobileTextScale === 'small' ? 'text-xl md:text-3xl' : 'text-3xl'} text-white leading-tight ${showRatingOnRight ? 'mb-1' : 'mb-0'} drop-shadow-lg group-hover:text-white/80 transition-colors`}>
             {course.name}
           </h3>
