  ...
  return (
    <div className={`relative group/row ${isFirstRow ? 'mb-4 md:mb-6' : 'mb-4 md:mb-6 lg:mb-8'}`}>
      ...
      <div className="relative">
        ...
        <div
          ref={carouselRef}
          className="flex overflow-x-auto no-scrollbar gap-2 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6 [--cards:2.5] md:[--cards:4.5] lg:[--cards:4.5] xl:[--cards:4.5] [--g:0.5rem] sm:[--g:0.75rem] md:[--g:1rem] lg:[--g:1.25rem] xl:[--g:1.5rem]"
          style={{
