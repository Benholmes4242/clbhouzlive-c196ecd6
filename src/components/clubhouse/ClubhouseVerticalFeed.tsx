                ...
                {hasMultipleMedia && (
                  <>
                    ...
                    <button
                      ...
                      className={`absolute ${isMobile ? '-left-2' : 'left-4'} top-1/2 -translate-y-1/2 z-30 p-0 transition-all duration-200 w-10 h-10 flex items-center justify-center`}
                    ...
                    <button
                      ...
                      className={`absolute ${isMobile ? '-right-2' : 'right-4'} top-1/2 -translate-y-1/2 z-30 p-0 transition-all duration-200 w-10 h-10 flex items-center justify-center`}
