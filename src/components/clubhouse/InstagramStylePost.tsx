    ...
    <>
      ...
      >
        ...
        >
          {currentMedia.media_type === 'video' ? (
            <div className="w-full h-full">
              <video
                ...
                autoPlay={false} // Let the video manager handle autoplay
                muted={true}
                loop={true}
                playsInline
              />
          ...
          {/* Video Controls */}
          {currentMedia.media_type === 'video' && shouldShowPlayIcon && (
            <>
