 ...
 * Combines metadata capsule and engagement rail with proper z-index and prop wiring
 */
...
export const AppleHUDOverlay = ({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-30">
      ...
      <div className="absolute left-3 right-3 md:left-4 md:right-4 bottom-[72px] md:bottom-[84px]">
        {/** avoid rendering an empty shell */}
        {(authorName || caption) && (
