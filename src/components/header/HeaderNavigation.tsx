...
const HeaderNavigation = () => {
  ...
  if (!user) {
    return (
      <>
        <Button variant="ghost" size="sm" className="p-2 md:p-3 flex-shrink-0 bg-white/10 backdrop-blur-sm hover:bg-white/20" onClick={handleNotificationsClick}>
          <Bell className="h-5 w-5 text-white drop-shadow-md" />
        </Button>

        <Button variant="ghost" size="sm" className="p-2 md:p-3 flex-shrink-0 bg-white/10 backdrop-blur-sm hover:bg-white/20" onClick={handleProfileClick}>
          <CircleUserRound className="h-5 w-5 md:h-6 md:w-6 text-white drop-shadow-md" />
        </Button>

        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="sm" className="p-2 md:p-3 flex-shrink-0 bg-white/10 backdrop-blur-sm hover:bg-white/20">
  ...
  return (
    <>
      <Button variant="ghost" size="sm" className="relative p-2 md:p-3 flex-shrink-0 bg-white/10 backdrop-blur-sm hover:bg-white/20" onClick={handleNotificationsClick}>
        <Bell className="h-5 w-5 text-white drop-shadow-md" />
        {unreadCount > 0 && (
