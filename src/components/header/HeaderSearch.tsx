    ...
    <>
      ...
      <div className="hidden md:flex items-center max-w-md w-full mx-4" ref={searchRef}>
        <div className="relative w-full">
          <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white h-10 w-10 z-10" style={{ minWidth: '25px', minHeight: '25px' }} />
          <input
            type="text"
            placeholder="Search players, courses, or content..."
            className="w-full pl-12 pr-10 py-2 bg-white/5 backdrop-blur-2xl border border-white/20 shadow-[0_0_20px_rgba(0,0,0,0.2)] rounded-full focus:outline-none focus:ring-2 focus:ring-muted-foreground/10 transition-all duration-200 text-white placeholder-white/70" style={{ backdropFilter: 'blur(40px) saturate(180%)' }}
            value={query}
