    ...
    <>
      ...
      <div className="hidden md:flex items-center max-w-md w-full mx-4" ref={searchRef}>
        <div className="relative w-full">
          <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white z-10" style={{ width: '25px', height: '25px' }} />
          <input
            type="text"
      ...
      >
        {showMobileSearch ? <X className="h-5 w-5" /> : <Search style={{ width: '25px', height: '25px' }} />}
      </Button>
