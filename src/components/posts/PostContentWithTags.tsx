  ...
  mentionableTags.forEach((tag, index) => {
    ...
    elements.push(
      <span
        ...
        className="font-bold hover:underline cursor-pointer bg-transparent border-none p-0 m-0 inline"
        style={{ color: 'var(--mention-color, #FFFFFF)', fontSize: 'inherit', lineHeight: 'inherit' }}
      >
        {tagText}
      </span>
    );
