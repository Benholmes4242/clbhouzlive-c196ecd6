...
const CoursePostBadge = ({ course, className = "", isClubhouse = false }: CoursePostBadgeProps) => {
  ...
  return (
    <div 
      className={`flex items-center cursor-pointer bg-transparent backdrop-blur-[1px] border border-white/25 rounded-full px-3 py-1.5 text-white shadow-lg shadow-black/10 ${className}`}
