    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 left-3 z-20">
          <div 
            className="flex items-center bg-white/20 text-white text-sm font-medium px-2 py-1 rounded-full backdrop-blur-sm border border-white/20 cursor-pointer hover:bg-white/30 transition-all"
            onClick={(e) => {
              e.stopPropagation();
              onProfileClick();
            }}
