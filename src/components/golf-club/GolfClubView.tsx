      ...
      <div className="course-hero-container relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-30">
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-black/28 backdrop-blur-[22px] border-t border-white/6 rounded-none shadow-[0_8px_30px_rgba(0,0,0,0.45),0_0_1px_rgba(255,255,255,0.16)] py-2 px-4 gap-2">
              <TabsTrigger value="about" className="flex items-center justify-center py-0 -mt-0.5 text-xl font-semibold text-white/70 !rounded-lg transition-opacity data-[state=active]:px-4 data-[state=active]:py-1.5 data-[state=active]:-mt-0.5 data-[state=active]:bg-white/16 data-[state=active]:backdrop-blur-[18px] data-[state=active]:border data-[state=active]:border-white/45 data-[state=active]:text-white data-[state=active]:shadow-[0_0_12px_rgba(0,0,0,0.35)]">About</TabsTrigger>
              <TabsTrigger value="reviews" className="flex items-center justify-center py-0 -mt-0.5 text-xl font-semibold text-white/70 !rounded-lg transition-opacity data-[state=active]:px-4 data-[state=active]:py-1.5 data-[state=active]:-mt-0.5 data-[state=active]:bg-white/16 data-[state=active]:backdrop-blur-[18px] data-[state=active]:border data-[state=active]:border-white/45 data-[state=active]:text-white data-[state=active]:shadow-[0_0_12px_rgba(0,0,0,0.35)]">Reviews</TabsTrigger>
              <TabsTrigger value="media" className="flex items-center justify-center py-0 -mt-0.5 text-xl font-semibold text-white/70 !rounded-lg transition-opacity data-[state=active]:px-4 data-[state=active]:py-1.5 data-[state=active]:-mt-0.5 data-[state=active]:bg-white/16 data-[state=active]:backdrop-blur-[18px] data-[state=active]:border data-[state=active]:border-white/45 data-[state=active]:text-white data-[state=active]:shadow-[0_0_12px_rgba(0,0,0,0.35)]">Media</TabsTrigger>
            </TabsList>
          </Tabs>
        </div>
      </div>
