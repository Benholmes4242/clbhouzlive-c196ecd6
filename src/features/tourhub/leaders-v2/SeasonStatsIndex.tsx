...
export function SeasonStatsIndex() {
  ...
  const tour: TourId = requested && requested in TOUR_CONFIG && requested !== 'champ' ? requested as TourId : 'pga';
  ...
  return <TourPageShell title={t('leaders.index.title')} backFallback="/tourhub?tab=leaderboards">
    <main style={{ minHeight: '100vh', paddingBottom: 32, background: A.CANVAS, fontFamily: FONT }}>
