    ...
    <>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'stretch', gap: 5, minWidth: 78 }}>
            {wins > 0 && (
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3, padding: '3px 7px', borderRadius: 6, background: 'rgba(247,147,30,0.07)', border: '0.5px solid rgba(247,147,30,0.2)', lineHeight: 1 }}>
