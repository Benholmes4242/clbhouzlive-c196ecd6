...
function LiveArenaSlide({ 
  ...
  const leaderPhotoUrl = tournament.leader ? getPlayerHeadshotUrl(tournament.leader.player.fullName, tournament.tourSlug || 'pga') : null;
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full" style={{ background: 'rgba(34, 197, 94, 0.15)', border: '1px solid rgba(34, 197, 94, 0.3)' }}>
              <span className="live-dot" style={{ width: '6px', height: '6px' }} />
              <span style={{ color: '#22C55E', fontSize: '11px', fontWeight: 700, letterSpacing: '1px' }}>LIVE</span>
            </div>
