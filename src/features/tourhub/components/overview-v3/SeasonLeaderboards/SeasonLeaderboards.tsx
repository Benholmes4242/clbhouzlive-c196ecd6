 ...
 * 
 * Redesigned as a page-level surface (no card wrapper).
 * Default: Champion Spotlight + 2 Chasers. Full list on demand.
 * Category tabs crossfade content like broadcast scene selectors.
 */
...
// Cinematic context lines per discipline
...
const SeasonLeaderboardsSkeleton = memo(function SeasonLeaderboardsSkeleton() {
  ...
  return (
    <section style={{ paddingTop: '40px', paddingBottom: '16px' }}>
      ...
      <div className="px-4">
        <div className="h-[200px] rounded-2xl" style={shimmerBg} />
      </div>
    </section>
  );
});
  ...
  return (
    <section style={{ paddingTop: '40px', paddingBottom: '16px' }}>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {/* Stat context line */}
          <div className="px-4 mb-3 flex items-center" style={{ gap: '8px' }}>
            <div
            ...
            <p className="m-0" style={{ fontSize: '13px', color: 'hsl(var(--muted-foreground))', fontWeight: 500 }}>
              {contextLine}
            </p>
          </div>
            ...
            <div className="px-4 mt-4">
              ...
              >
                <span style={{
                  ...
                  color: showFullList ? accent.primary : 'rgba(0,0,0,0.4)',
                ...
                >
                  <ChevronDown size={14} style={{
                    color: showFullList ? accent.primary : 'rgba(0,0,0,0.3)',
                    transition: 'color 0.25s ease',
                  }} />
                </motion.div>
              </button>
