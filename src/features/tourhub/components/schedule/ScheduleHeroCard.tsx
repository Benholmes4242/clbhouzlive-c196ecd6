...
const DOT = (
  <span style={{ color: 'rgba(255,255,255,0.25)', margin: '0 3px', userSelect: 'none' }}>·</span>
);
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {winnerStats && (
                      <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', marginTop: 4, gap: 0 }}>
                        ...
                        <span style={{ color: 'rgba(255,255,255,0.35)', fontSize: 11, fontWeight: 500 }}>
                          {winnerStats.birdies} birdies
                        </span>
                        {DOT}
                        <span style={{ color: 'rgba(255,255,255,0.35)', fontSize: 11, fontWeight: 500 }}>
                          {winnerStats.pars} pars
                        </span>
                        {winnerStats.bogeys > 0 && (
                          <>{DOT}<span style={{ color: 'rgba(255,255,255,0.35)', fontSize: 11, fontWeight: 500 }}>
                            {winnerStats.bogeys} bogeys
                          </span></>
                        )}
                        {DOT}
                        <span style={{ color: 'rgba(255,255,255,0.35)', fontSize: 11, fontWeight: 500 }}>
                          {winnerStats.rounds} rounds
                        </span>
                      </div>
                    )}
                  </div>
