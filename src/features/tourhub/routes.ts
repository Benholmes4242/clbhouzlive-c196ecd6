...
/* TC1 (2026-09-20): the college hub, profile and head-to-head route helpers
   were removed with the pages they served. /tourhub/college-golf* now
   redirects to Tour Hub (see App.tsx). */
