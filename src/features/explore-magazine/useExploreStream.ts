...
import { dedupePages, warnDuplicates } from './dedupeStream';
...
function roundPayload(row: StreamRow): CircleRoundRow | undefined {
  ...
  return {
    ...
    player_club_id: null,
    /* THE RARITY LINES DO NOT LIVE ON THIS PAYLOAD. They are read once per page
       from get_round_feat_lines, so this path needs to know nothing about them. */
