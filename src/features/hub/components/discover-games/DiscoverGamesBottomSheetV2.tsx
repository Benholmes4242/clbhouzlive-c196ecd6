      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed bottom-0 inset-x-0 mx-auto z-[10000] w-full max-w-[480px] flex flex-col rounded-t-[24px] overflow-hidden discover-games-sheet-wrapper ${hasStackedSheet ? 'stacked-behind' : ''}`}
            style={{
              height: '90svh',
              maxHeight: '90svh',
              background: '#F8FAFC',
