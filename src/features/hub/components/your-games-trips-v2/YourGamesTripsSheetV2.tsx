      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed bottom-0 inset-x-0 mx-auto z-[10000] w-full max-w-[480px] flex flex-col rounded-t-[24px] overflow-hidden your-games-trips-sheet-wrapper ${hasStackedSheet ? 'stacked-behind trip-stacked-behind' : ''}`}
            style={{
              height: '90svh',
              maxHeight: '90svh',
              background: '#F8FAFC',
