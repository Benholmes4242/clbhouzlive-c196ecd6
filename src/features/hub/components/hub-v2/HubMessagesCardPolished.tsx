      ...
      <div className="flex-none flex gap-2 p-4">
          <button
            onClick={handleNewChat}
             className={`flex-1 h-11 bg-[${HUB_COLORS.messagesNewChatBg}] text-[${HUB_COLORS.messagesNewChatText}] rounded-full text-[0.9375rem] font-semibold active:opacity-90 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2A9D5C] focus-visible:ring-offset-2`}
