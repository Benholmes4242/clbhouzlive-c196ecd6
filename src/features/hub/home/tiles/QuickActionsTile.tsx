...
function QA({ labelTop, labelBottom, onClick, icon }: { 
  ...
  return (
    ...
    >
      <div className="qa-icon" style={{ fontSize: '18px', lineHeight: 1 }} aria-hidden="true">{icon}</div>
      <div className="qa-label" style={{ 
        ...
        <span style={{ fontSize: '11.5px', textAlign: 'center', color: 'var(--hub-text-body)' }}>{labelTop}</span>
        <span style={{ fontSize: '11.5px', textAlign: 'center', color: 'var(--hub-text-body)' }}>{labelBottom}</span>
      </div>
    </button>
  );
}
