      ...
      {editingId === conversation.id ? (
        <div className="flex items-center gap-2">
          <input
            ...
            autoFocus
            className="flex-1 bg-background text-foreground rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
      ) : (
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="p-4 border-b border-border space-y-3">
        ...
        <input
          ...
          className="w-full bg-secondary text-foreground rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
