  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row gap-3 p-3 pb-2">
        ...
        <div className="flex flex-col justify-center min-w-0 flex-1">
          ...
          <div className="flex flex-row items-center justify-between gap-2 mb-0.5">
            ...
            <div className="text-[12px] leading-tight text-white/60 shrink-0">
              {golfer.distanceText || '0.2 mi'} away
            </div>
          </div>

          {/* Force-render home club centered under name */}
          <div className="text-[13px] leading-tight text-white/70 text-center self-center truncate max-w-full">
      ...
      <div className="px-3 pb-3">
        {/* Pills row - Force-render BOTH pills centered for visual QA */}
