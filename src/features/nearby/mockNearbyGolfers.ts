...
export function getMockNearby(count = 5): NearbyGolfer[] {
  const base: NearbyGolfer[] = [
    { 
      ...
      avatar_url: 'https://picsum.photos/seed/anna/200/200', 
      is_online: true, 
      distance_km: 0.4, 
      same_club: false,
      isOpenToPlay: true
    ...
    { 
      ...
      avatar_url: 'https://picsum.photos/seed/tom/200/200', 
      is_online: true, 
      distance_km: 1.2, 
      same_club: false,
      isOpenToPlay: false
    ...
    { 
      ...
      avatar_url: 'https://picsum.photos/seed/mia/200/200', 
      is_online: false, 
      distance_km: 2.1, 
      same_club: false,
      isOpenToPlay: false
    ...
    { 
      ...
      avatar_url: 'https://picsum.photos/seed/ben/200/200', 
      is_online: true, 
      distance_km: 0.7, 
      same_club: true,
      isOpenToPlay: true
    ...
    { 
      ...
      avatar_url: 'https://picsum.photos/seed/classic/200/200', 
      is_online: false, 
      distance_km: 3.8, 
      same_club: false,
      isOpenToPlay: false
