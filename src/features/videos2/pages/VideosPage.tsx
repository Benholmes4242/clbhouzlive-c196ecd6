...
export default function VideosPage(){
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur flex items-center justify-between px-4 py-3 border-b border-gray-800/70">
        <h1 className="text-xl font-bold text-[#6e9277]">clbhouz</h1>
        <div className="flex gap-4 text-gray-300 text-xl"><i className="ri-search-line"/><i className="ri-notification-3-line"/><i className="ri-user-line"/></div>
      </div>
      <FilterBar active="All"/>
      <div ref={parentRef} className="h-[calc(100vh-120px)] overflow-auto no-scrollbar relative">
