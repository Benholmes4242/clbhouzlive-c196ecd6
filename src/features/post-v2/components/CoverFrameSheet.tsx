    ...
    <BottomSheet open={open} title="Cover frame" onClose={onClose}>
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={onClose} style={{ flex: 1, background: inkWithAlpha(SURFACE.dark.ink, 0.06), color: CT.ink, border: `1px solid ${CT.hairlineStrong}`, borderRadius: 12, padding: '12px', fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.10em', cursor: 'pointer' }}>Cancel</button>
