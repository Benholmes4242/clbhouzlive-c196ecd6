        ...
        <div style={{ position: 'absolute', inset: 0, background: 'rgba(15,17,23,0.35)', display: 'flex', alignItems: 'flex-end', zIndex: 10 }}>
          <div style={{ width: '100%', background: CT.canvas, padding: 16, borderTopLeftRadius: 18, borderTopRightRadius: 18, display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={() => setConfirmId(null)} style={{ flex: 1, background: surfaceWithAlpha(LIGHT_ROUTE_CANVAS, 0.06), border: '1px solid rgba(255,255,255,0.12)', borderRadius: 12, padding: '12px', fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.10em', cursor: 'pointer', color: CT.ink }}>Cancel</button>
              <button
