...
// v9: session audio flips are handled inside the engine via
// onSessionAudioChange → reconcileAudio. No module-level subscription needed;
// leaving this file free of writer paths outside the reconciler.
