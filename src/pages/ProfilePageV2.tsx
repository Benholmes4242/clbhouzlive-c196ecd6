    ...
    <PageRoot className="min-h-screen" style={{ background: BG_COLOR }}>
      ...
      <div className="relative">
        ...
        <div className="absolute right-5 top-full mt-3 z-20 flex items-center gap-2">
          {/* HCP pill - white, bigger with centered text */}
          {profile?.eg_handicap_index != null && (
            <span 
              className="px-3.5 py-1.5 text-sm font-semibold rounded-full text-[#0F0F0F] inline-flex items-center justify-center"
              style={{ 
                background: '#FFFFFF',
          ...
          {/* Golfer pill - transparent green glass, bigger with centered text */}
          <span 
            className="px-3.5 py-1.5 text-sm font-semibold rounded-full text-emerald-700 inline-flex items-center justify-center"
            style={{ 
      ...
      <div className="mt-5 px-5 flex items-center gap-2">
        ...
        <button 
          className="flex-1 h-9 rounded-full text-sm font-semibold text-white flex items-center justify-center"
        ...
        <button 
          className="flex-1 h-9 rounded-full text-sm font-semibold text-[#0F0F0F] flex items-center justify-center gap-1.5"
          style={{
            background: '#fff',
      ...
      <div className="mt-6 px-5">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-sm font-medium text-[#5E666D]">Posts</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium text-[#5E666D]">Followers</span>
          </button>
          ...
          {isPersonal && (
            ...
            >
              ...
              <span className="text-sm font-medium text-[#5E666D]">Friends</span>
            </button>
          )}
        </div>
      </div>
