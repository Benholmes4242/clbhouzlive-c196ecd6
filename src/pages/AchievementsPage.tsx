// AchievementsPage - Full page version with new ring progression design
...
const AchievementsPage: React.FC<AchievementsPageProps> = ({
  ...
  console.log('AchievementsPage rendering - v3.0 with new design');
  ...
  const skillAchievements: Achievement[] = [
    ...
    { title: "Birdie Blitz", emoji: "🐦", isEarned: true, description: "Score 3 birdies in one round", xp: 150, isRepeatable: true, progress: "3/3", dateEarned: "2025-08-08" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="pt-16 pb-20">
        {/* Page Header */}
        <div className="relative p-6 text-center bg-white dark:bg-gray-800 border-b">
        ...
        <div className="w-full" style={{ paddingTop: isMobile ? '20px' : '30px', paddingBottom: isMobile ? '130px' : '60px' }}>
          ...
          {(activeFilter === 'all' || activeFilter === 'exploration') && getFilteredAchievements(explorationAchievements, 'exploration').length > 0 && (
            <div className={`${isMobile ? 'px-0 pb-6' : 'px-6 pb-8'}`}>
              ...
              <div className="p-6 bg-white dark:bg-gray-800 rounded-lg mx-4">
