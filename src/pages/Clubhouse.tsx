...
const Clubhouse = () => {
  ...
  return (
    <div className="h-screen bg-transparent overflow-hidden relative" style={{
      ...
      <div 
        className={`absolute top-0 left-0 right-0 z-40 transition-transform duration-300 ease-out backdrop-blur-sm bg-white/1 supports-[backdrop-filter]:bg-white/0 border-b border-white/2 ${
