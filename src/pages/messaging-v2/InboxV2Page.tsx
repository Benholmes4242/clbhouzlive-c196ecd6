    ...
    <ManagePageShell title="Messages" right={composeButton}>
      <div style={{ background: CANVAS, color: INK, minHeight: '100%' }}>
        ...
        {!hasActor ? (
          ...
          <div
            className="flex flex-col items-center justify-center text-center"
            style={{ padding: '80px 24px', gap: 24, flex: 1, overflow: 'hidden' }}
          >
            <style>{`
              ...
              .inbox-squircle {
                animation: inbox-float 3.6s ease-in-out infinite;
              ...
              @media (prefers-reduced-motion: reduce) {
                .inbox-ripple { display: none; }
                .inbox-squircle { animation: none; }
                .inbox-sheen { animation: none; display: none; }
              }
            `}</style>
            <div
              style={{
            ...
            >
              <span className="inbox-ripple" style={{ animationDelay: '0s' }} />
              <span className="inbox-ripple" style={{ animationDelay: '1.4s' }} />
              <span className="inbox-ripple" style={{ animationDelay: '2.8s' }} />
              <div
