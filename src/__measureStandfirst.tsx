...
const base = (img: string | null, sf: string | null) => ({ id: 's', kind: 'story', ring: 'own', lane: 'news', score: 1, consequence: null,
  ...
  who: null, facts: { headline: 'A championship story with a headline long enough to wrap', standfirst: sf, published_at: new Date().toISOString() }, payload: {}, seen: false }) as any;
const rows: any[] = [];
