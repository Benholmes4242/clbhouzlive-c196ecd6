  ...
  public: {
    Tables: {
      ...
      business_tag_visibility: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "review_post_like_count_drift"
      ...
      generic_invite_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "generic_invite_codes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "gam_friend_handicap_leaderboard_view"
            referencedColumns: ["user_id"]
      ...
      generic_invite_sends: {
        ...
        Relationships: [
          {
            foreignKeyName: "generic_invite_sends_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "gam_friend_handicap_leaderboard_view"
            referencedColumns: ["user_id"]
      ...
      whs_invite_completions: {
        ...
        Relationships: [
          {
            foreignKeyName: "whs_invite_completions_invite_id_fkey"
            columns: ["invite_id"]
            isOneToOne: true
            referencedRelation: "whs_invite_status"
            referencedColumns: ["id"]
          },
          {
            ...
            columns: ["invite_id"]
            isOneToOne: true
            referencedRelation: "whs_invites"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Views: {
      ...
      whs_invite_status: {
        Row: {
          ...
          invitee_passport_id: number | null
    ...
    Functions: {
      ...
      get_viewer_standing:
        ...
        | {
            Args: { p_board: string; p_viewer: string }
            Returns: {
              board: string
              course_id: string
              course_name: string
