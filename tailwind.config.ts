	...
	fontFamily: {
		...
		'playfair': ['"Geist"', 'sans-serif'],
			...
			colors: {
				...
				'media-loading': 'hsl(var(--media-loading) / <alpha-value>)',
				'brand-orange': 'hsl(var(--brand-orange) / <alpha-value>)',
				'brand-orange-hover': 'hsl(var(--brand-orange-hover) / <alpha-value>)',
				'brand-orange-light': 'hsl(var(--brand-orange-light) / <alpha-value>)',
